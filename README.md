...
- 北京、济南、上海、苏州、广州、厦门、福州的 35,055 条成员字读音，以及吴音、汉音、唐音分层
- GitHub Pages 自动部署
...
`data:sources` 默认批量查询全部 19,495 个《广韵》成员字的方言读音；日语查询默认限制为 70 个代表字。可通过 `DIALECT_LIMIT` 和 `JAPANESE_LIMIT` 调整。外部站点批量查询前应确认许可并控制请求频率。
